package Lab2IC.service;

import Lab2IC.curent.Curent;
...
public class Service {
    ...
    public double addNota(Nota nota, String feedback){
        ...
        System.out.println("Saptamana predare: " + predare + "-- deadline tema: " + tema.getDeadline());
    ...
    public void prelungireDeadline(String nrTema, int deadline){
        ...
        System.out.println("Current week aka diff: " + diff);
